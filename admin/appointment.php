...
include('header.php');
//session_start();
$_SESSION["buttonStatus"] = "";
if($_SESSION['type']=='Admin'){
    
    $_SESSION["buttonStatus"] = "Check in";
}else{

    $_SESSION["buttonStatus"] = "Check out";
}
                    ...
                    <div class="card shadow mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="row input-daterange">
                                                <div class="col-md-6">
                                                    <input placeholder="From" type="text" name="start_date" id="start_date" class="form-control form-control-sm" readonly />
                                                </div>
                                                <div class="col-md-6">
                                                    <div>
                                                        <input placeholder="To" type="text" name="end_date" id="end_date" class="form-control form-control-sm" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="appointment">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    if($_SESSION['type'] == 'Admin'){
                        ...
                        echo'<input type="submit" name="save_appointment" id="save_appointment" class="btn btn-primary" value="Check in" />';
                    }else{
                        
                        echo'<input type="submit" name="save_appointment" id="save_appointment" class="btn btn-success" value="Check out" />';
...
$(document).ready(function(){
    ...
    {
        var dataTable = $('#appointment').DataTable({
            "processing" : true,
            "serverSide" : true,
            "order" : [],
            "ajax" : {
        ...
        {       
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    var sess_var = "<?php echo $_SESSION['buttonStatus']?>";
                    $('#save_appointment').val(sess_var);
