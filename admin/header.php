...
<head>
    ...
    <title>Brgy Rosario Appointment System</title>
    ...
    <!-- for dashboard menus popout -->
    <link rel="stylesheet" type="text/css" href="../menucss/menu.css"/>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Rosario Appointment</div>
            </a>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="official_schedule.php">
                    <i class="fas fa-user-clock"></i>
                    <span>Brgy Official Schedule</span></a>
            </li>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="official_profile.php">
                    <i class="far fa-id-card"></i>
                    <span>Profile</span></a>
            </li>
            <?php
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="official_profile.php">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <div class="dropdown-divider"></div>
